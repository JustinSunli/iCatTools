...
using iCat.TextEditor.Util;

namespace iCat.TextEditor
{
...
//			((DefaultWorkbench)WorkbenchSingleton.Workbench).UpdateToolbars();
		...
		{
			new iCat.TextEditor.Actions.Delete().Execute(textArea);
		}
		
		public void SelectAll(object sender, EventArgs e)
		{
			new iCat.TextEditor.Actions.SelectWholeDocument().Execute(textArea);
		}
