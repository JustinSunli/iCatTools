...
namespace GenBusiness
{
    class XType
    {
        public static string getCSharpTypeName(string typeId)
        {
            #region
            string typeName = "";
            switch (typeId)
        ...
        public static string getUIModelTypeName(string typeId)
        {
            #region
            string typeName = "";
            switch (typeId)
        ...
        /// <param name="typeId"></param>
        /// <returns></returns>
        public static string getFuncName(string typeId)
        {
            #region
            string funcName = "";
            switch (typeId)
